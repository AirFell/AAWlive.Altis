...
switch (side player) do {
	case west: {"respawn_west" setMarkerPosLocal getMarkerPos _RandomPosW;};
	case east: {"respawn_east" setMarkerPosLocal getMarkerPos _RandomPosE;};
	case resistance: {"respawn_guerrila" setMarkerPosLocal getMarkerPos _RandomPosG;};
};
