...
class AAWHud {
	...
	duration = 20;
	name= "AAWHud";
	onLoad = "uiNamespace setVariable ['AAWHud', _this select 0]";
	
	class controlsBackground {
		class AAWHud_Vehicle:RscText
		{
			idc = hud_vehicle_idc;
		...
		class AAWHud_ActivityIcon:RscText
		{
		...
		class AAWHud_ActivityTextBox:RscText
		{
