...
_nul = switch (side player) do {
	case west: {
		...
		["Air","B_Helipilot_F"] execVM "client\driverCheck.sqf";
		["Tank", "B_crew_F"] execVM "client\driverCheck.sqf";
	...
	case east: {
		...
		["Air","O_Helipilot_F"] execVM "client\driverCheck.sqf";
		["Tank", "O_crew_F"] execVM "client\driverCheck.sqf";
